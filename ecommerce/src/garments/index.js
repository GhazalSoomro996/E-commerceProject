...
export default class Garments  extends React.Component{
    constructor(props){
        super(props);
        this.state={
            cname:'',
    ...
    async smartphone(){
        ...
        axios({
            method:'post',
            url:'http://localhost:9000/garments',
            data:{
        ...
        return(
            <div>
                ...
                <br /> <br />
                        ...
                        <input type='text' onChange={(e)=>this.setState({model:e.target.value})} /><br />
